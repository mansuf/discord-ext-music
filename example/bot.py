"""
discord-ext-music example music bot. (https://github.com/mansuf/discord-ext-music/blob/main/example/bot.py)

You must have discord.py (with voice support), youtube-search-requests, youtube-dl, and av installed.

``pip install discord.py[voice] youtube-search-requests youtube-dl av``
"""
